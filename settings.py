...
if 'test' in sys.argv:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'peoplel6_fuxing',               # Or path to database file if using sqlite3.
            'USER': 'peoplel6_fuxing',               # Not used with sqlite3.
            'PASSWORD': 'jessie61-PEOPLELINKED',                # Not used with sqlite3.
