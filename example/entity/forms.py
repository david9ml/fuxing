...
class OptionDetailForm(AjaxForm):
    year = forms.CharField(widget=forms.Textarea(attrs={'rows': 1, 'style': 'width:600px;'}))
    level = forms.CharField(widget=forms.Textarea(attrs={'rows': 1, 'style': 'width:600px;'}))
    subject = forms.CharField(widget=forms.Textarea(attrs={'rows': 1, 'style': 'width:600px;'}))
