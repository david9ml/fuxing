(function ($) {
   ...
   global_legends.clear = function (thiscanvas) {
    ...
    var buildToolBar = function(parent, csrfvalue, id){
        var canvasname = $(parent).attr('id');
        var toolbarhtml='<span class="ui-widget-header ui-corner-all intemasscanvas-toolbar" style="float:left;">'; toolbarhtml += '<input type="checkbox" class="lineBtn" id="'+canvasname+'-lineBtn"/><label for="'+canvasname+'-lineBtn" style="width:40px;height:40px">Add Line</label>';
